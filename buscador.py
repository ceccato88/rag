...
class MultimodalRagSearcher:
    def __init__(self) -> None:
        """Inicializa clientes Voyage, OpenAI e Astra DB."""
        load_dotenv()
        ...
        try:
            ...
            # Verificar se collection existe (tentativa de busca simples)
            try:
    ...
    def search_candidates(
        ...
        try:
            logger.info("Buscando similaridade no Astra DB…")
            
            # Busca vetorial usando Astra DB
            ...
            logger.error("Erro busca Astra DB: %s", e)
            return []
...
def main() -> None:
    try:
        ...
        print("🚀 BUSCADOR RAG MULTIMODAL (Astra DB) 🚀")
        print("=" * 60)
